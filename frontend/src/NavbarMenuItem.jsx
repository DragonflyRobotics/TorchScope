...
function NavbarMenuItem() {
    return (
        <Menu as="div" className="w-80 bg-primary-translucent rounded-full p-4 flex items-center relative">
            ...
            <MenuItems
                transition
                className="absolute top-10 w-5/6 bg-white rounded-lg transition focus:ring-0 focus:ring-offset-0 data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
            >
                <div className="py-1">
                    <MenuItem>
                        <a
